...
/**
 * Novitus Online Fiscal Printer — Odoo 19
 *
 ...
 * - BasePrinter at app/utils/printer/base_printer (moved)
 * - this.pos.getOrder() instead of this.pos.get_order()
 */
export class NovitusPrinter extends BasePrinter {
    ...
    // ── Helper: RPC via PosStore.data service (Odoo 19 pattern) ──
    ...
    async printReceipt(receipt) {
        // v19: getOrder() instead of get_order()
